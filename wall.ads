package Wall is
   ...
   procedure Put (Brick : in Brick_Type; X : in Width; Y : in Height);

   procedure Erase (Brick : in Brick_Type; X : in Width; Y : in Height);

   procedure Place (Brick : in Brick_Type; X : in Width; Y : in Height);
